            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <img src="{{ 
                                $event->poster_path 
                                    ? (str_starts_with($event->poster_path, 'assets/') 
                                        ? asset($event->poster_path)  // Untuk data lama di public/assets
                                        : asset('storage/' . $event->poster_path)  // Untuk data baru di storage
                                    )
                                    : 'https://placehold.co/16x20' 
                            }}" 
                                class="w-16 h-20 rounded-xl object-cover shadow-sm"
                                onerror="this.src='https://placehold.co/16x20'">                       </td>
                        <td class="px-8 py-6">
                        ...
                        <td class="px-8 py-6">
                        <div class="flex gap-2">  <!-- ✅ Div sekarang di dalam td -->
                            <!-- Tombol EDIT -->
